...
const charsList: { [key: string]: string }[] = [
    { " ": "\u00A0" },
    { 0: "\u07C0" },
    {
...
const diacriticChars = charsList.reduce<{ [key: string]: string }>((acc, charList) => {
    const [char, specialChars] = Object.entries(charList)[0];

    const specialCharsValues = specialChars
        .split("")
        .reduce<{ [key: string]: string }>((values, specialChar) => {
